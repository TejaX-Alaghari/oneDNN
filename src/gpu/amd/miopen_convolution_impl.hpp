...
public:
    ...
    status_t init(engine_t *engine, convolution_pd_t *pd,
        ...
        if (conv_bias_eltwise)
        {
            ...
            miopenConvFwdAlgorithm_t *Algos=NULL;
...
protected:
    ...
    status_t init_scratchpad(engine_t *engine, convolution_pd_t *pd) override {
        ...
        CHECK(MIOPEN_EXECUTE_FUNC_S(miopenConvolutionBackwardDataGetSolutionCount,handle,
                                    descs[io::y],
                                    weights_desc,
                                    conv_desc,
                                    descs[io::x],
        ...
        CHECK(MIOPEN_EXECUTE_FUNC_S(miopenConvolutionBackwardDataGetSolution,handle, 
                                    descs[io::y], 
                                    weights_desc, 
                                    conv_desc, 
                                    descs[io::x], 
        ...
        CHECK(MIOPEN_EXECUTE_FUNC_S(miopenConvolutionBackwardDataGetSolutionWorkspaceSize,handle, 
                            descs[io::y], 
                            weights_desc, 
                            conv_desc, 
                            descs[io::x], 
        ...
        CHECK(MIOPEN_EXECUTE_FUNC_S(miopenConvolutionBackwardDataCompileSolution,handle, 
                                    descs[io::y],
                                    weights_desc,
                                    conv_desc, 
                                    descs[io::x], 
...
public:
    ...
    status_t init_scratchpad(engine_t *engine, convolution_pd_t *pd) override {
        ...
        CHECK(MIOPEN_EXECUTE_FUNC_S(miopenConvolutionBackwardWeightsGetSolutionCount,handle,
                                                 descs[io::y],
                                                 descs[io::x],
                                                 conv_desc,
                                                 weights_desc,
        ...
        CHECK(MIOPEN_EXECUTE_FUNC_S(miopenConvolutionBackwardWeightsGetSolution,handle,
                                            descs[io::y],
                                            descs[io::x],
                                            conv_desc,
                                            weights_desc,
        ...
        CHECK(MIOPEN_EXECUTE_FUNC_S(miopenConvolutionBackwardWeightsGetWorkSpaceSize, handle,
							descs[io::y],
							descs[io::x],
							conv_desc,
                            weights_desc,
        ...
        CHECK(MIOPEN_EXECUTE_FUNC_S(miopenConvolutionBackwardWeightsCompileSolution, handle,
                                                descs[io::y],
                                                descs[io::x],
                                                conv_desc,
                                                weights_desc,
